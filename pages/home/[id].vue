<template>
  <button @click="createProduct()" class="px-3 py-2 rounded-md bg-red-500 text-white inline-flex items-center justify-center" >Click</button>
  <h1 class="text-3xl" key="dataProduct">
...
import { useMyProductStore } from '~/stores/product';
  ...
  const createProduct = async ()=> {
    ...
    await productStore.postProduct(data)
    console.log('clicked')
    fetchData()
  }
