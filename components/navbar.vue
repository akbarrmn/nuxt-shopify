<template>
  <nav>
    <div
      class="w-full flex items-center justify-between gap-5 px-10 py-4 shadow-sm shadow-black/20"
    >
      <div class="flex gap-5 w-full items-center">
        <div class="flex items-center gap-5">
          ...
          <div class="flex flex-col">
            <p>Meraki Shop</p>
            <p class="text-sm text-gray-500">merakiui.com</p>
          </div>
        </div>
      ...
      <div class="flex items-center justify-end gap-5 w-full">
        <div class="flex items-center w-full max-w-md">
          ...
          <input
            type="text"
            placeholder="T-shirt"
            class="block bg-gray-100 w-full rounded-l-none rtl:rounded-l-lg rtl:rounded-r-none placeholder-gray-400/70 rounded-lg border border-l-0 border-gray-200 px-2 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"
          />
          <span class="bg-gray-100 h-full py-2.5 px-3 min-w-fit border-gray-200 border rtl:rounded-r-lg">
            <svg
        ...
        <div class="flex gap-2">
          <button
            type="button"
            class="rounded-full p-2 text-red-500 bg-red-300"
          >
            <svg
    ...
    <div
      class="w-full py-5 shadow-sm shadow-black/20 flex justify-center gap-6"
    >
      <h1>Deal Today</h1>
